...
// ✅ NEW - Paradise Routes
const ParadiseRoutes = require('./All_Fms_Api/Paradise/paradiseRoutes');
...
// ✅ NEW - Paradise Routes (JV Project)
app.use('/api/paradise', ParadiseRoutes);
