...
//   // ✅ Check if status is Not Deployed
...
//       // ✅ If status is Not Deployed, clear other fields
...
//       // ✅ If changing from Not Deployed to Deployed, re-fill from Step 3
...
//       // ✅ Only add other fields if NOT "Not Deployed"
...
//               {/* ✅ Show Not Deployed Info Message */}
//               {isNotDeployed && (
//                 <div className="p-4 bg-red-50 rounded-xl border border-red-200 animate-fadeIn">
//                   <div className="flex items-center gap-2 text-red-700">
//                     <XCircle className="w-5 h-5" />
//                     <span className="text-sm font-semibold">Not Deployed Mode</span>
//                   </div>
//                   <p className="text-xs text-red-600 mt-2">
//                     Labour was not deployed. You can add an optional remark and submit. Other fields are not required.
//                   </p>
//                 </div>
//               )}

//               {/* ✅ Only show these fields if NOT "Not Deployed" */}
//               {!isNotDeployed && (
//                 <>
...
//                   rows={3}
//                   placeholder={isNotDeployed ? "Enter reason for not deploying..." : "Enter any remarks for approval..."}
...
//                 ) : (
//                   <>
//                     {isNotDeployed ? <XCircle className="w-4 h-4" /> : <Send className="w-4 h-4" />}
//                     <span>{isNotDeployed ? 'Mark Not Deployed' : 'Submit Approval'}</span>
//                   </>
//                 )}
//               </button>
//             </div>
    ...
    <div style={{ maxWidth: 1400, margin: '0 auto', padding: '0 8px' }}>
      ...
      <div style={{ background: T.card, borderRadius: 10, border: `1px solid ${T.border}`, padding: '12px 16px', marginBottom: 12, display: 'flex', gap: 12, alignItems: 'center' }}>
        <div style={{ position: 'relative', flex: 1 }}>
          ...
          <input type="text" placeholder="Search by UID, project, contractor..." value={searchTerm} onChange={(e) => setSearchTerm(e.target.value)}
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 6, padding: '8px 14px', background: T.borderLight, borderRadius: 8, fontSize: 13, color: T.textLight, fontWeight: 600, whiteSpace: 'nowrap' }}>
          <Filter size={14} /> Total: <span style={{ color: T.gold, fontWeight: 700 }}>{filteredData.length}</span>
        </div>
      </div>
