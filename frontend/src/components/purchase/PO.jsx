...
//   // ✅ handleGeneratePO - Material_Size properly pass kiya
...
//         // ✅ Dono naam - original aur alternative
//         uid:           item.UID,
//         UID:           item.UID,
//         Material_Name: item.Material_Name,
//         materialName:  item.Material_Name,
//         Material_Size: item.Material_Size || '',   // ✅ SIZE - YEH MISSING THA
//         materialSize:  item.Material_Size || '',   // ✅ backup field naam
...
//                               <thead>
//                                 <tr style={{ background: T.navy }}>
//                                   {/* ✅ Disc column hata diya, Size add kiya */}
//                                   {['#', 'UID', 'Material', 'Size', 'Qty', 'Unit', 'Rate', 'CGST', 'SGST', 'IGST', 'Final', 'Total'].map((h, i) => (
//                                     <th key={i} style={{
...
//                                     </td>
//                                     {/* ✅ Disc hata diya */}
//                                     <td style={{ padding: '8px 10px', textAlign: 'center' }}>{item.CGST_5}%</td>
//                                     <td style={{ padding: '8px 10px', textAlign: 'center' }}>{item.SGST_5}%</td>
//                                     <td style={{ padding: '8px 10px', textAlign: 'center' }}>{item.IGST_5}%</td>
...
//                             <thead>
//                               <tr style={{ background: T.navy }}>
//                                 {/* ✅ DISC column hata diya */}
//                                 {['VENDOR FIRM', 'RATE', 'CGST', 'SGST', 'IGST', 'FINAL RATE', 'QTY', 'UNIT', 'TOTAL VALUE', 'TRANSPORT'].map((h, i) => (
//                                   <th key={i} style={{
