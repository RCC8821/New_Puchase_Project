...
//     { label: 'Material Name', w: 160 }, { label: 'Size', w: 80 },
...
//                                 {r.materialName}
//                                 {r.materialSize && <span style={{ marginLeft: 6, fontSize: 10, color: T.goldDark }}>📏 {r.materialSize}</span>}
//                               </div>
...
//                   <thead>
//                     <tr style={{ background: T.navy }}>
//                       {['UID', 'Req No', 'Site', 'Supervisor', 'Material', 'Size', 'SKU', 'Rev Qty', 'Final Qty', 'Unit', 'Indent No', 'Vendor'].map((h, i) => (
