...
//     if (!material?.UID) return;
//     setSelectedMaterial(material);
//     setStatus(material.STATUS_7 || '');
//     setExpectedDeliveryDate(
//       material.EXPECTED_DELIVERY_DATE_7
//         ? material.EXPECTED_DELIVERY_DATE_7.split('/').reverse().join('-')
//         : ''
//     );
//     setRemark(material.REMARK_RECEIVED_VENDOR_7 || '');
//     setIsModalOpen(true);
...
//     setStatus(''); setExpectedDeliveryDate(''); setRemark('');
//     setIsSaving(false); setSaveSuccess(false); setSaveError('');
//   };

//   const handleUpdate = async () => {
//     if (!selectedMaterial || !status || !expectedDeliveryDate || !remark) {
//       setSaveError('All fields are required');
//       return;
//     }

//     const updatedFollowUpCount = (parseInt(selectedMaterial.FOLLOW_UP_COUNT_7 || '0') + 1).toString();
...
//         setMaterials(prev => prev.filter(m => m.UID !== selectedMaterial.UID));
//       } else {
//         setMaterials(prev => prev.map(m =>
//           m.UID === selectedMaterial.UID
//             ? {
//                 ...m,
//                 STATUS_7: status,
//                 EXPECTED_DELIVERY_DATE_7: expectedDeliveryDate,
//                 REMARK_RECEIVED_VENDOR_7: remark,
//                 FOLLOW_UP_COUNT_7: updatedFollowUpCount,
//               }
//             : m
//         ));
//       }
...
//   // Table columns with ALL important data
//   const tableCols = [
//     // { label: '#', w: 50 },
//     { label: 'UID', w: 60 },
//     { label: 'Req No', w: 90 },
...
//     { label: 'Material Type', w: 110 },
//     { label: 'Material Name', w: 160 },
//     { label: 'Size', w: 90 },
//     { label: 'SKU', w: 90 },
//     { label: 'Qty', w: 70 },
//     { label: 'Unit', w: 60 },
//     { label: 'Brand', w: 130 },           // 🆕 Brand visible
//     { label: 'Indent No', w: 100 },
//     { label: 'Indent PDF', w: 90 },       // 🆕 PDF link
//     { label: 'Quotation', w: 100 },
//     { label: 'Quote PDF', w: 90 },        // 🆕 PDF link
//     { label: 'PO No', w: 90 },
//     { label: 'PO PDF', w: 90 },           // 🆕 PDF link
//     { label: 'Vendor Firm', w: 140 },
//     { label: 'Contact', w: 110 },
//     { label: 'PO Delivery', w: 110 },
//     { label: 'Planned 7', w: 100 },
//     { label: 'Status', w: 110 },
//     { label: 'Follow-ups', w: 90 },
//     { label: 'New Exp Date', w: 110 },
//     { label: 'Vendor Remark', w: 130 },
//     { label: 'Action', w: 80 },
//   ];
...
//                     {/* 🆕 Brand */}
//                     <Td maxW={120}>
//                       {mat['DECIDED_BRAND/COMPANY_NAME_2'] ? (
//                         <span style={{
//                           background: `${T.purple}15`, color: T.purple,
//                           padding: '3px 8px', borderRadius: 5,
//                           fontSize: 11, fontWeight: 600,
//                         }}>{mat['DECIDED_BRAND/COMPANY_NAME_2']}</span>
//                       ) : '—'}
//                     </Td>
...
//                       {mat.PDF_URL_3 ? (
//                         <a href={mat.PDF_URL_3} target="_blank" rel="noopener noreferrer"
//                           title="View Indent PDF"
//                           style={{
...
//                     <td style={{ padding: '10px 14px', borderBottom: `1px solid ${T.border}`, textAlign: 'center' }}>
//                       {mat.PDF_URL_5 ? (
//                         <a href={mat.PDF_URL_5} target="_blank" rel="noopener noreferrer"
...
//                     <td style={{ padding: '10px 14px', borderBottom: `1px solid ${T.border}`, textAlign: 'center' }}>
//                       {mat.PDF_URL_6 ? (
//                         <a href={mat.PDF_URL_6} target="_blank" rel="noopener noreferrer"
//                           title="View PO PDF"
//                           style={{
//                             display: 'inline-flex', alignItems: 'center', gap: 3,
//                             padding: '4px 8px', borderRadius: 5,
...
//                     <Td>
//                       {mat.Vendor_Contact ? (
//                         <a href={`tel:${mat.Vendor_Contact}`}
//                           style={{
//                             display: 'inline-flex', alignItems: 'center', gap: 4,
//                             color: T.navy, fontSize: 12, fontWeight: 600,
//                             textDecoration: 'none',
//                           }}>
//                           <Phone size={11} /> {mat.Vendor_Contact}
//                         </a>
//                       ) : '—'}
//                     </Td>
...
//                       {mat.STATUS_7 ? (
//                         <span style={{
//                           background: mat.STATUS_7 === 'Dispatched' ? `${T.success}15`
//                             : mat.STATUS_7 === 'Partition' ? `${T.warning}20`
//                             : `${T.danger}15`,
//                           color: mat.STATUS_7 === 'Dispatched' ? T.success
//                             : mat.STATUS_7 === 'Partition' ? '#92400e'
//                             : T.danger,
//                           padding: '3px 8px', borderRadius: 6,
//                           fontSize: 11, fontWeight: 600,
//                         }}>{mat.STATUS_7}</span>
...
//                           background: T.borderLight, padding: '3px 8px',
...
//                     <Td center>
//                       <span style={{
//                         background: parseInt(mat.FOLLOW_UP_COUNT_7 || 0) > 3
//                           ? `${T.danger}15` : `${T.gold}15`,
//                         color: parseInt(mat.FOLLOW_UP_COUNT_7 || 0) > 3
//                           ? T.danger : T.goldDark,
//                         padding: '3px 10px', borderRadius: 6,
//                         fontSize: 12, fontWeight: 700,
//                       }}>
//                         {mat.FOLLOW_UP_COUNT_7 || '0'}
//                       </span>
//                     </Td>
...
//                   display: 'flex', alignItems: 'center', justifyContent: 'center',
//                 }}>
//                   <MessageCircle size={16} color={T.gold} />
//                 </div>
//                 <div>
...
//                   </h3>
//                   <p style={{ fontSize: 12, color: T.textMuted, margin: 0 }}>
//                     UID: {selectedMaterial.UID} | PO: {selectedMaterial.PO_NUMBER_6}
//                   </p>
//                 </div>
//               </div>
...
//             }}>
//               <div style={{
//                 fontSize: 13, fontWeight: 700, color: T.navy, marginBottom: 8,
//               }}>
//                 {selectedMaterial.Material_Name}
//                 {selectedMaterial.Material_Size && (
//                   <span style={{
//                     marginLeft: 8, background: `${T.gold}15`, color: T.goldDark,
//                     padding: '2px 8px', borderRadius: 4,
//                     fontSize: 11, fontWeight: 600,
//                   }}>📏 {selectedMaterial.Material_Size}</span>
//                 )}
//               </div>
//               <div style={{
...
//               }}>
//                 <div>
//                   <span style={{ color: T.textMuted }}>Brand: </span>
//                   <strong style={{ color: T.navy }}>{selectedMaterial['DECIDED_BRAND/COMPANY_NAME_2'] || '—'}</strong>
//                 </div>
//                 <div>
//                   <span style={{ color: T.textMuted }}>Vendor: </span>
//                   <strong style={{ color: T.navy }}>{selectedMaterial.Vendor_Firm_Name_5}</strong>
//                 </div>
//                 <div>
//                   <span style={{ color: T.textMuted }}>Qty: </span>
//                   <strong>{selectedMaterial.REVISED_QUANTITY_2 || selectedMaterial.Quantity} {selectedMaterial.Unit_Name}</strong>
//                 </div>
//                 <div>
//                   <span style={{ color: T.textMuted }}>Follow-ups: </span>
//                   <strong style={{ color: T.gold }}>
//                     {selectedMaterial.FOLLOW_UP_COUNT_7 || '0'} → {(parseInt(selectedMaterial.FOLLOW_UP_COUNT_7 || 0) + 1)}
//                   </strong>
//                 </div>
//                 <div>
//                   <span style={{ color: T.textMuted }}>Contact: </span>
//                   <strong style={{ color: T.navy }}>{selectedMaterial.Vendor_Contact || '—'}</strong>
//                 </div>
//                 <div>
//                   <span style={{ color: T.textMuted }}>PO Delivery: </span>
//                   <strong>{selectedMaterial.EXPECTED_DELIVERY_DATE_6 || '—'}</strong>
//                 </div>
//               </div>
//             </div>
...
//                 }}>
//                   <CheckCircle size={16} color={T.success} /> Follow-up updated successfully!
//                 </div>
//               )}
//               {saveError && (
//                 <div style={{
...
//                   disabled={isSaving}
//                   placeholder="Enter vendor follow-up remark..."
//                   rows={4}
//                   style={{ ...inputBase, resize: 'vertical', minHeight: 80, borderColor: !remark ? T.danger : T.border }}
//                   onFocus={focusGold} onBlur={blurNormal}
//                 />
//               </div>
//             </div>
...
//             }}>
//               <p style={{ fontSize: 12, color: T.textMuted, margin: 0 }}>
//                 {status && expectedDeliveryDate && remark
//                   ? <><CheckCircle size={12} style={{ display: 'inline', color: T.success }} /> Ready to update</>
//                   : 'Fill all fields'}
//               </p>
...
//                     cursor: (status && expectedDeliveryDate && remark && !isSaving)
//                       ? 'pointer' : 'not-allowed',
//                     boxShadow: (status && expectedDeliveryDate && remark && !isSaving)
...
//                   ) : (
//                     <><CheckCircle size={15} /> Update Follow-Up</>
//                   )}
//                 </button>
//               </div>
//             </div>
