...
//     specification: '', brandName: '', skuCode: '',
...
//   // ── Project Change → Auto-fill Engineer ──
...
//     // Material Type change → reset all below
...
//     // Material Name change → reset size, spec, sku
...
//     // Material Size change → ONLY auto-fill SKU (spec UNCHANGED)
...
//       // Specification UNCHANGED (size se independent hai)
//     }

//     setItems(updated);
//   };

//   // ── Get sizes for material name ──
//   const getSizesForName = (materialName) => {
//     if (!materialName) return [];
//     return maps.nameToSizes?.[materialName.toLowerCase()] || [];
//   };

//   // 🆕 Get ALL specs for material name (no size filter)
...
//     if (!formData.projectName || !formData.engineerName) return false;
//     for (const item of items) {
//       if (!item.materialType || !item.materialName || !item.quantity) return false;
//     }
//     return true;
//   }, [formData, items]);
...
//               style={{
//                 ...S.inputReadonly,
//                 borderLeft: formData.engineerName ? `3px solid ${T.success}` : `3px solid ${T.border}`,
//               }}
...
//           const specs = getSpecsForName(item.materialName);  // 🆕 No size filter
...
//                 <SearchableSelect label="Material Type" required
//                   value={item.materialType}
//                   onChange={(val) => handleItemChange(idx, 'materialType', val)}
//                   options={uv.materialTypes || []}
//                   placeholder="Select Type" />

//                 <SearchableSelect label="Material Name" required
...
//                   options={sizes}
//                   placeholder={item.materialName ? `Select Size (${sizes.length})` : "Select material first"}
...
//                 {/* 🆕 Specification - filtered ONLY by Material Name */}
//                 <SearchableSelect
//                   label="Specification"
...
//                   onChange={(val) => handleItemChange(idx, 'brandName', val)}
//                   options={uv.brandNames || []}
...
//                     )}
//                   </label>
//                   <input type="text" readOnly value={item.skuCode}
//                     style={{
//                       ...S.inputReadonly,
//                       borderLeft: item.skuCode ? `3px solid ${T.success}` : `3px solid ${T.border}`,
//                     }}
...
//                     style={S.input} placeholder="Enter qty"
...
//                 <div>
//                   <label style={S.label}>Require Days</label>
//                   <div style={{ position: 'relative' }}>
//                     <select value={item.reqDays}
//                       onChange={(e) => handleItemChange(idx, 'reqDays', e.target.value)}
//                       style={S.select} onFocus={focusStyle} onBlur={blurStyle}>
...
//                     style={S.input} placeholder="Enter description"
//                     onFocus={focusStyle} onBlur={blurStyle} />
//                 </div>
//               </div>
...
//                 ><Plus size={15} /> Add Another Item</button>
//               )}
//             </div>
//           );
//         })}
...
//           fontSize: 12, lineHeight: 1.6, color: T.warningText,
//           borderLeft: `3px solid ${T.gold}`,
//         }}>
//           <strong>Note:</strong> यह Item केवल उसी ठेकेदार (Contractor) के कार्य हेतु है
//           जिसे 'With Material' का कार्य दिया गया है।
//         </div> */}
//         <div>
//           <label style={S.label}>Remark</label>
//           <input type="text" value={formData.remark}
//             onChange={(e) => setFormData(prev => ({ ...prev, remark: e.target.value }))}
//             style={S.input} placeholder="Enter remark (optional)"
//             onFocus={focusStyle} onBlur={blurStyle} />
//         </div>
//       </div>
...
//             <AlertCircle size={14} /> Fill Project, Engineer, Material Type, Name & Quantity
//           </p>
//         ) : (
//           <p style={{ fontSize: 12, color: T.success, display: 'flex', alignItems: 'center', gap: 4, margin: 0 }}>
//             <CheckCircle size={14} /> Form ready to submit
//           </p>
//         )}
...
//               boxShadow: isFormValid && !submitting ? `0 2px 8px ${T.gold}40` : 'none',
//               transition: 'all 0.2s',
//             }}
//             onMouseEnter={(e) => {
...
//               if (isFormValid && !submitting) e.currentTarget.style.boxShadow = `0 2px 8px ${T.gold}40`;
//             }}
//           >
//             {submitting ? (
