...
const OutStanding = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (
      ...
      alert(
        "All required fields must be filled correctly (Basic Amount > 0)"
      );
      return;
    }
    ...
    try {
      ...
      await axios.post(
        `${import.meta.env.VITE_BACKEND_URL}/api/outStading/submit-Outstanding-data`,
        payload
      );
  ...
  const resetForm = () => {
    setFormData({
      ...
      sgst: "",
      netAmount: "",
      remark: "", // ✅ Reset remark too
    });
  };

  if (loading)
    return (
      <div className="text-center mt-10 text-gray-600">Loading sites...</div>
    );
        ...
        <div className="mb-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <SearchableSelect
              ...
              onChange={(val) =>
                setFormData((prev) => ({ ...prev, expHead: val }))
              }
              options={expHeads}
