...
const Dashboard = () => {
  ...
  const allPurchasePages = [
    ...
    { id: 'BillCheckedData', name: 'Bill Checked Data', icon: Truck, component: BillCheckedData, path: '/dashboard/BillCheckedData', allowedUserTypes: ['admin', 'Abhishek Sharma'] },
    ...
    { id: 'Bill_Checked_18Step', name: 'Bill Checked 18 Step', icon: Truck, component: Bill_Checked_18Step, path: '/dashboard/Bill_Checked_18Step', allowedUserTypes: ['admin', 'Ravi Rajak'] },
