    ...
    <BrowserRouter>
      <Routes>
        ...
        <Route path="/dashboard" element={<Dashboard />}>
          ...
          {/* ═══ JV PROJECT — PARADISE ROUTES (NEW) ═══ */}
          <Route path='paradise' element={<ParadiseDashboard />} />
          <Route path='paradise/out-form' element={<ParadiseOutForm />} /> 
          <Route path='paradise/store-inventory' element={<ParadiseStoreInventory />} />
          <Route path='paradise/site-engineer' element={<ParadiseSiteEngineer />} />
          <Route path='paradise/boq-qty' element={<ParadiseBOQQty />} />
        </Route>
      </Routes>
    </BrowserRouter>
  );
